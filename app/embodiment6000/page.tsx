...
const meta = {
  ...
  pageUrl: "https://emotionalsobrietycoaching.com/embodiment6000"
}
...
export default function Embodiment6000Page() {
  const amount = 6000
      ...
      function initializeShopifyButton() {
        ...
        (window as any).ShopifyBuy.UI.onReady(client).then(function (ui: any) {
          ui.createComponent('product', {
            id: '15348971503689',
            node: document.getElementById('product-component-1750473114670'),
            ...
            <div className="lg:w-1/2 flex flex-col justify-between">
              <div>
                ...
                <div className="mt-8">
                  ...
                  <div id='product-component-1750473114670'></div>
                </div>
              </div>
            </div>
            <div className="lg:w-1/2 flex flex-col justify-between">
