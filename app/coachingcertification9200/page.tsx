            ...
            <div className="lg:w-1/2 flex flex-col justify-between">
              <div>
                ...
                <div className="mt-12">
                  ...
                  <form name="PrePage" method = "post" action = "https://Simplecheckout.authorize.net/payment/CatalogPayment.aspx"> <input type = "hidden" name = "LinkId" value ="6e5ee759-32e7-4305-b76c-da2572b40f60" /> <input type = "image" src ="//content.authorize.net/images/buy-now-gold.gif" /> </form>
                </div>
                <div className="mt-8">
