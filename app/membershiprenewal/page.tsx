...
const meta = {
  title: "The Next Chapter 1-YEAR Membership Renewal",
  description: "Evidence-based brain training for professional women who want to reduce their drinking by 80 percent.",
  imageUrl: "https://emotionalsobrietycoaching.com/renewal.png",
  pageUrl: "https://emotionalsobrietycoaching.com/membershiprenewal"
}
  ...
  <div className="bg-white p-6 rounded-lg shadow-xl mb-8">
    ...
    <div className="border-b border-gray-200 pb-4 mb-4">
      ...
      <div className="flex justify-between">
        <span className="text-[#46474c]">TNC 1-YEAR Membership Renewal</span>
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
          <div className="flex flex-col lg:flex-row gap-12">
            <div className="lg:w-1/2 flex flex-col justify-between">
              <div>
                <h1 className="text-5xl font-bold mb-6 text-[#bda5a3]">The Next Chapter 1-YEAR Renewal</h1>
            ...
            <div className="lg:w-1/2 flex flex-col justify-between">
              <Image src="/renewal.png" alt="TNC 1 Year Renewal" width={800} height={800} className="w-full mb-8 rounded-lg shadow-xl transform hover:scale-105 transition-all" />
