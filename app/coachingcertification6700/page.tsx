...
const meta = {
  title: "Coaching Certification - $6700",
  ...
  pageUrl: "https://emotionalsobrietycoaching.com/coachingcertification6700"
}
...
export default function CoachingCertification6700Page() {
  const amount = 6700
      ...
      function initializeShopifyButton() {
        ...
        (window as any).ShopifyBuy.UI.onReady(client).then(function (ui: any) {
          ui.createComponent('product', {
            id: '15348972060745',
            node: document.getElementById('product-component-1750473298868'),
            ...
            <div className="lg:w-1/2 flex flex-col justify-between">
              <div>
                ...
                <div className="mt-12">
                  ...
                  <form name="PrePage" method = "post" action = "https://Simplecheckout.authorize.net/payment/CatalogPayment.aspx"> <input type = "hidden" name = "LinkId" value ="b8ec330e-6c50-4e46-97de-e243a18dc601" /> <input type = "image" src ="//content.authorize.net/images/buy-now-gold.gif" /> </form>
                </div>
                <div className="mt-8">
                  <p className="text-lg text-[#46474c] mb-4 font-montserrat">To checkout with Affirm, use the button below:</p>
                  <div id='product-component-1750473298868'></div>
                </div>
              </div>
            </div>
            <div className="lg:w-1/2 flex flex-col justify-between">
