    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-pink-50">
      ...
      <main className="pt-20">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col md:flex-row items-center">
              <div className="md:w-1/2 mb-8 md:mb-0 md:pr-8">
                <h1 className="text-5xl font-bold mb-4 text-purple-800">Hi, My Name Is Colleen.</h1>
                <h2 className="text-3xl mb-6 text-purple-600">And I&apos;m not an alcoholic.</h2>
                <p className="text-xl mb-8">As a high-functioning perfectionist, my goal was to get better at drinking....</p>
                <p className="text-2xl font-bold text-purple-800">Everything changed the day I decided to get better at thinking.</p>
              </div>
        ...
        <section className="py-20 bg-gradient-to-br from-purple-100 to-pink-100">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-4xl font-bold mb-8 text-center text-purple-800">Colleen Kachmann</h2>
            <h3 className="text-2xl mb-8 text-center text-purple-600">Master life coach and addiction recovery specialist</h3>
            <div className="flex flex-col md:flex-row items-center">
              <div className="md:w-1/2 mb-8 md:mb-0 md:pr-8">
                <Image src="/closeup.webp" alt="Colleen Kachmann" width={500} height={500} className="rounded-lg shadow-xl" />
              </div>
              <div className="md:w-1/2">
                <p className="text-lg mb-4">Colleen Kachmann is a recovery-certified Master Coach, host of the globally ranked It&apos;s Not About the Alcohol podcast, and author of Life Off the Label: A Handbook for Creating Your Own Brand of Health and Happiness.</p>
                <p className="text-lg mb-4">Colleen uses holistic, evidence-based strategies in neurophysiology and growth mindset to help women stop over-drinking without going to AA or giving up alcohol completely by reconnecting with their intuition and personal power.</p>
                <p className="text-lg mb-4">Education: Colleen holds a MSc in health coaching, a BS in biology and chemistry education and is certified as a women&apos;s functional and integrative medicine professional.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 bg-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-4xl font-bold mb-8 text-purple-800">It&apos;s Not About the Alcohol</h2>
            <div className="max-w-3xl mx-auto">
              ...
              <p className="text-lg font-bold">Because it felt ridiculous to refer to myself an an alcoholic after I quit drinking.</p>
            </div>
            <div className="mt-8">
        ...
        <section className="py-20 bg-gradient-to-br from-purple-100 to-pink-100">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-4xl font-bold mb-8 text-center text-purple-800">Radical Responsibility</h2>
            <div className="flex flex-col md:flex-row items-center">
              <div className="md:w-1/2 mb-8 md:mb-0 md:pr-8">
                <Image src="/walking.jpeg" alt="Colleen walking in nature" width={500} height={500} className="rounded-lg shadow-xl" />
              </div>
              <div className="md:w-1/2">
                <p className="text-lg mb-4">As children, we&apos;re taught to control our behavior at the expense of our emotions. Keep your chin up. Don&apos;t cry. Smile. When someone asks how you are, say, &quot;I&apos;m fine.&quot; Even if you&apos;re not. Especially when you&apos;re not.</p>
                ...
                <p className="text-lg mb-4">The irony is that ignoring our needs makes them stronger. We become victims of circumstance, passive aggressive communication specialists and beholden to subconscious urges.</p>
                <p className="text-lg font-bold">[Spoiler Alert] If you are not actively managing your emotional needs, they are managing you.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 bg-gradient-to-r from-purple-600 to-pink-600 text-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <Link href="/book" className="bg-white text-purple-700 hover:bg-purple-100 font-bold py-3 px-6 rounded-full inline-flex items-center transition-all">
