...
const meta = {
  ...
  pageUrl: "https://emotionalsobrietycoaching.com/pay3000"
}
      ...
      function initializeShopifyButton() {
        ...
        (window as any).ShopifyBuy.UI.onReady(client).then(function (ui: any) {
          ui.createComponent('product', {
            id: '15348967768137',
            node: document.getElementById('product-component-1750472207439'),
            ...
            <div className="lg:w-1/2 flex flex-col justify-between">
              <div>
                ...
                <div className="mt-8">
                  ...
                  <div id='product-component-1750472207439'></div>
                </div>
              </div>
            </div>
            <div className="lg:w-1/2 flex flex-col justify-between">
